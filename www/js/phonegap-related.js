...
function DebugMsg(msg) {
	...
	console.log("svgMotion Debug: " + msg);
}
...
function pgSaveFile(fileData, defaultFileName, onSuccess, onError, onProgress) {
	...
	// This sets the parent directory of the svgMotion folder we will save to
	...
	var afterGotParentDir = function(dir){
		...
		dir.getDirectory('svgMotion', { create: true }, function(dir){
			startSave(dir);
		},
		function(){
			DebugMsg('failed to get svgMotion dir');
